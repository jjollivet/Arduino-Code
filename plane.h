...
#define AILERON_INPUT_PIN 9//we should be able to delete anything to do with aileron and elevator.
...
//XXX Calibrate - DONE
//#define CALIBRATE_ROLL_PITCH //if this line is not commented, the plane will print out desired vs current roll / pitch
